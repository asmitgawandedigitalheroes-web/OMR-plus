...
interface LanguageContextValue {
  ...
  t: (key: string) => string;
  /** Render dynamic bilingual DB content: returns arValue when lang=ar and non-empty, else enValue */
  tDb: (enValue: string, arValue: string | null | undefined) => string;
  isRTL: boolean;
}
...
const en: Record<string, string> = {
  ...
  'client.profileSettings': 'Profile & Settings',
  'client.accountInfo': 'Account Information',
  'client.personalInfo': 'Personal Information',
  'client.fullName': 'Full Name',
  'client.phone': 'Phone Number',
  'client.emailAddress': 'Email Address',
  'client.memberSince': 'Member Since',
  'client.saveChanges': 'Save Changes',
  'client.saved': 'Saved!',
  'client.changePassword': 'Change Password',
  'client.sendResetEmail': 'Send Password Reset Email',
  'client.resetEmailSent': 'Reset email sent! Check your inbox.',
  'client.profileUpdated': 'Profile updated successfully.',
  'coach.profile': 'Profile',
  'coach.profileSettings': 'Profile & Settings',
  ...
  'client.bodyFatPct': 'Body Fat %',
  'client.muscleMassKg': 'Muscle Mass (kg)',
...
const ar: Record<string, string> = {
  ...
  'client.bodyFatPct': 'نسبة الدهون %',
  'client.muscleMassKg': 'الكتلة العضلية (كغ)',
  ...
  'client.profileSettings': 'الملف الشخصي والإعدادات',
  'client.accountInfo': 'معلومات الحساب',
  'client.personalInfo': 'المعلومات الشخصية',
  'client.fullName': 'الاسم الكامل',
  'client.phone': 'رقم الهاتف',
  'client.emailAddress': 'البريد الإلكتروني',
  'client.memberSince': 'عضو منذ',
  'client.saveChanges': 'حفظ التغييرات',
  'client.saved': 'تم الحفظ!',
  'client.changePassword': 'تغيير كلمة المرور',
  'client.sendResetEmail': 'إرسال رابط إعادة تعيين كلمة المرور',
  'client.resetEmailSent': 'تم إرسال البريد الإلكتروني! تحقق من بريدك الوارد.',
  'client.profileUpdated': 'تم تحديث الملف الشخصي بنجاح.',
  'coach.profile': 'الملف الشخصي',
  'coach.profileSettings': 'الملف الشخصي والإعدادات',
...
export function LanguageProvider({ children }: { children: ReactNode }) {
  ...
  const [overrides, setOverrides] = useState<Record<string, { en: string; ar: string }>>({});
  ...
  // Fetch CMS overrides from content_blocks once on mount
  useEffect(() => {
    async function fetchOverrides() {
      try {
        ...
        data.forEach(row => { map[row.key] = { en: row.value_en, ar: row.value_ar ?? '' }; });
        setOverrides(map);
      } catch (err) {
  ...
  const tDb = useCallback((enValue: string, arValue: string | null | undefined): string => {
    if (lang === 'ar' && arValue) return arValue;
    return enValue;
  }, [lang]);

  return (
    <LanguageContext.Provider value={{ lang, setLang, t, tDb, isRTL: lang === 'ar' }}>
      {children}
